  ...
  const data = [
    {
      ...
      age: "CSEPTAES",
      address:
        "Chef Service de l’exploitation, des postes de travail, des applications et des services",
      type: "Chef Service",

      tags: "Direction des Sytèmes d’Information",
    },
    {
      key: "1",
      age: "CSEPTAES",
        ...
        title={() => {
          return (
            <Row justify="space-between">
              <p style={{ fontWeight: "bold", color: "black" }}>Fonctions</p>
              <Button
                style={{
                  color: "white",
