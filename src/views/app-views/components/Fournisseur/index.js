  ...
  function success() {
    ...
    Modal.success({
      ...
      content: (
        <Col>
          <Divider />
          <p>Le Fournisseur a été ajouté avec succès.</p>
          <button
            type="primary"
            style={{
        ...
        title={() => {
          return (
            <Row justify="space-between">
              <p style={{ fontWeight: "bold", color: "black" }}>Fournisseur</p>
              <Button
                style={{
                  color: "white",
        ...
        >
          ...
          >
            <Form.Item
              ...
              rules={[{ required: true }]}
            >
              <Select placeholder="Fournisseur" allowClear>
                <Option value="male">SONY</Option>
                <Option value="female">UNIFY</Option>
              </Select>
            </Form.Item>
            <Form.Item
              label="Téléphone"
