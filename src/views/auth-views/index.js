    ...
    <Suspense fallback={<Loading cover="page" />}>
      <Switch>
        ...
        <Route
          ...
          component={lazy(() => import(`./authentication/Reset`))}
        />

        <Route
          path={`${AUTH_PREFIX_PATH}/first-page`}
          component={lazy(() => import(`./authentication/first-page`))}
        />
        ...
        <Redirect
          ...
          to={`${AUTH_PREFIX_PATH}/first-page`}
        />
      </Switch>
    </Suspense>
  );
